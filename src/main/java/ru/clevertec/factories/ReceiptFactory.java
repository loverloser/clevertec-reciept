...
//            value.setTotal();
//            String temp = String.format("%-5d%-17s$%-14.2f$%-11.2f%n", value.getId(), value.getName(),
...
//    }
//
//    public static void writeFooter(Map<Long, Product> products, DiscountCard discountCard) {
